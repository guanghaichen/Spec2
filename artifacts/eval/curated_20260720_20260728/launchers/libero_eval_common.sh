...
init_libero_eval_env() {
  ...
  if [[ -d "/data/wulin" ]]; then
    ...
    DEFAULT_DFLASH_OUTPUT_DIR="/data/wulin/c/specvla-data/ckpt_goal_dflash_joint_domino_1layer_b16x1_4gpu_packedv2"
    ...
    DEFAULT_DFLASH_OUTPUT_DIR="${DEFAULT_ROOT}/specvla-data/ckpt_goal_dflash_joint_domino_1layer_b16x1_4gpu_packedv2"
    ...
    DEFAULT_DFLASH_OUTPUT_DIR="/mnt/storage/cgh/specvla-data/ckpt_goal_dflash_joint_domino_1layer_b16x1_4gpu_packedv2"
    ...
    DEFAULT_DFLASH_OUTPUT_DIR="/mnt/3b51049a-abd1-486a-89ce-cfd16ced42a8/cgh/specvla-data/ckpt_goal_dflash_joint_domino_1layer_b16x1_4gpu_packedv2"
