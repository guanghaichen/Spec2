...
class GenerateConfig:
    ...
    pretrained_checkpoint: Union[str, Path] = "/mnt/3b51049a-abd1-486a-89ce-cfd16ced42a8/cgh/data/models--openvla--openvla-7b-finetuned-libero-object"     # Pretrained checkpoint path
    ...
    draft_backend: str = "eagle"                    # eagle | dflash
    accept_threshold: int = 0
    dflash_block_size: int = 4
    dflash_num_draft_layers: int = 1
    ...
    #################################################################################################################
    spec_checkpoint: Union[str, Path] = "/mnt/3b51049a-abd1-486a-89ce-cfd16ced42a8/cgh/specvla-data/ckpt_libero_goal_debug_ckpt"
        ...
        wandb.log(
            {
                ...
                "spec/length/total": total_generation_summary["length"] if total_generation_summary else None,
                "spec/avg_accept_length/total": total_generation_summary["avg_accept_length"] if total_generation_summary else None,
            }
        )
