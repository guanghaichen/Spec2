...
def eval_libero(cfg: GenerateConfig) -> None:
    ...
    target_dir = "/mnt/3b51049a-abd1-486a-89ce-cfd16ced42a8/cgh/SpecVLA-main/openvla/specdecoding/test-speed/libero_goal_dflash_relaxed"
    ...
    local_log_timefilepath = os.path.join(target_dir, run_id + "libero_goal_dflash_relaxed.json")
