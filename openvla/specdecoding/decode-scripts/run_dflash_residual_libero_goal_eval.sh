...
export TASK_SUITE_NAME="${TASK_SUITE_NAME:-libero_goal}"
TASK_SUITE_SLUG="${TASK_SUITE_NAME#libero_}"
...
export RUN_ID_NOTE="${RUN_ID_NOTE:-dflash-cad-relaxed-${TASK_SUITE_SLUG}-e${EVAL_EPOCH}-r${ACCEPT_THRESHOLD}}"
