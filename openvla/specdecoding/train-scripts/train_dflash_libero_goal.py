...
def parse_args():
    ...
    parser.add_argument("--swanlab_log_every_steps", type=int, default=20, help="SwanLab 普通 loss/accuracy 标量记录间隔；默认与本地 metrics.jsonl 同步")
    parser.add_argument("--swanlab_detail_every_steps", type=int, default=200, help="SwanLab 详细 anchor/position 指标记录间隔；低频记录以避免百万级 records")
